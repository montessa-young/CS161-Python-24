...
# You can not edit the text, only add the modify strings methods we learned and change array locations
print(story_noun_list[0] + " had a " + story_adj_list[0] + " " + story_noun_list[1] + ".")
